...
`,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Oferta de Lançamento do LeoPilot Lite, desbloqueie o OpenAI o1, GPT-4o, Claude-3.5 e os mais recentes grandes modelos agora",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Usar LeoPilot Lite AI",
        Label: "(A solução mais econômica)",
        SubTitle:
          "Mantido oficialmente pelo LeoPilot Lite, pronto para uso sem configuração, suporta os mais recentes grandes modelos como OpenAI o1, GPT-4o e Claude-3.5",
