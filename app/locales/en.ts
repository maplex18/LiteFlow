...
const en: LocaleType = {
  ...
  Auth: {
    ...
    TopTips:
      "🥳 LeoPilot Lite launch promotion: Instantly unlock the latest models like OpenAI o1, GPT-4o, Claude-3.5!",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Provider: {
      ...
      SubStatus: "Check currently available model providers"
    },
    Sync: {
      CloudState: "Cloud Sync",
      NotSyncYet: "Not synced yet",
  ...
  Mask: {
    ...
    Config: {
      ...
      HideContext: {
        ...
        SubTitle: "Do not show in-context prompts in chat (system prompts are always hidden)",
      },
      Artifacts: {
