  ...
  return (
    <div className={styles["privacy-container"]}>
      <div className={styles["privacy-header"]}>
        <div className={styles["privacy-title"]}>隱私權保護政策</div>
        <IconButton
          icon={<CloseIcon />}
      ...
      <div className={styles["privacy-content"]}>
        ...
        <section>
          <h2>八、聯繫管道</h2>
          <p>對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請前往「國眾官網」與我們聯繫。</p>
          <p>聯繫我們：<a href="https://www.leosys.com/index.php/contactus" target="_blank" rel="noopener noreferrer">https://www.leosys.com/index.php/contactus</a></p>
        </section>
      </div>
    </div>
  );
